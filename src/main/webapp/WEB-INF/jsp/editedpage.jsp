...
<c:url var="addUrl" value="/izludec/main/news/add"/>
    ...
    <div class="well" style="background-color:#ffffff;">
        ...
        <center><h2><p>Новость номер ${id} отредактирована! <br> Дата: <fmt:formatDate value="${now}" pattern="dd-MM-yyyy"/></p></h2><br>
        <a href="${mainUrl}" class="delete btn btn-success" id="btn-add-comment">Главная</a>
        </center>
    </div>

...
<c:forEach items="${news}" var="news">
    ...
    <div class="article">
    <h2><a href="------"><c:out value="${news.head}" /></a></h2>
    ...
    <div class="category"><a href="${bytag}?tag=${news.category}">${news.category}</a></div><a href="${shownews}" class="more">Читать</a><a href="${deleteUrl}" class="delete">Удалить</a><a href="${editUrl}" class="delete">Изменить</a>
    <div class="clear"></div>
    </div>
</c:forEach>
...
<a class="add" href="${addUrl}">Добавить новость</a><br>

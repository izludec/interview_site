    ...
    <table style="width:500px !important;">
		<tr>
			<td><form:label path="id">Номер</form:label></td>
                        <td><form:input style="width:auto;" path="id" disabled="true"/></td>
		</tr>
		...
		<tr>
			...
			<td><form:input style="width:auto;" size="103" path="category"/></td>
		</tr>
                
                <tr>
			<td><form:label path="date">Дата</form:label></td>
			<td><form:input style="width:auto;" size="35" path="date" disabled="true"/></td>
		</tr>
